...
test tryInteger {
    ...
    const cases = [_]struct {
        ...
        .{ "004284", .{ .underlying = 4284, .form = .{ .radix = null, .sign = null, .zero = true, .delimited = false } } },
        ...
        .{ "#004284", .{ .underlying = 4284, .form = .{ .radix = .decimal, .sign = null, .zero = false, .delimited = false } } },
        ...
        .{ "x004ac", .{ .underlying = 0x4ac, .form = .{ .radix = .hex, .sign = null, .zero = false, .delimited = false } } },
        ...
        .{ "-x004ac", .{ .underlying = cast(-0x4ac), .form = .{ .radix = .hex, .sign = .{ .value = .negative, .position = .pre_radix }, .zero = false, .delimited = false } } },
        ...
        .{ "+0b101", .{ .underlying = 0b101, .form = .{ .radix = .binary, .sign = .{ .value = .positive, .position = .pre_radix }, .zero = true, .delimited = false } } },
        // Bounds checking
